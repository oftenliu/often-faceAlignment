...
def video_input_fn(data_dir,img_size,num_lmark):
    ...
    def _get_frame():
        i = 0
        while True:
            frame = cv2.imread(img_path[i], cv2.IMREAD_GRAYSCALE)
...
def main(argv):
    ...
    input_function = flags.use_synthetic_data and get_synth_input_fn() or vgg16_input_fn #use vgg16_input_fn
